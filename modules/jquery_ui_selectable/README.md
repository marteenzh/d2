...
jQuery UI Selectable library for any themes and modules that require it.

  - jQuery UI [Selectable documentation](https://jqueryui.com/selectable/)
  - jQuery UI [Selectable API documentation](https://api.jqueryui.com/selectable/)
...
2.  Change any references in your theme or module from
    `core/jquery.ui.selectable` to `jquery_ui_selectable/selectable`
