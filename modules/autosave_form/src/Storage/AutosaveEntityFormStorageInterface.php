...
interface AutosaveEntityFormStorageInterface {
   ...
   */
  public function purgeAutosavedEntityState($entity_type_id, $entity_id, $form_id = NULL, $langcode = NULL, $uid = NULL);

  /**
   * Purges all autosaved states for all entities of the given entity type.
   *
   * @param string $entity_type_id
   *   The entity type id.
   * @param string $langcode
   ...
   */
  public function purgeAutosavedEntitiesStates($entity_type_id, $langcode = NULL, $uid = NULL);
